...
* 
*/
class intrunkVCExtendAddonClass {
	function __construct() {
		// We safely integrate with VC with this hook
		add_action( 'init', array( $this, 'intrunkIntegrateWithVC' ) );
	}

	public function intrunkIntegrateWithVC() {
		//Checks if visual composer is not installed
		if ( ! defined( 'WPB_VC_VERSION' ) ) {
			add_action( 'admin_notices', array( $this, 'intrunkShowVcVersionNotice' ) );
			return;
		}
	...
	public function intrunkShowVcVersionNotice() {
