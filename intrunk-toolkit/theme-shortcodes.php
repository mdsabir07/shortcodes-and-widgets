...
// Banner Shortcode
function intrunk_banner_section_shortcode( $atts, $content = null ) {
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-sm-12 my-auto text-center">
                	<div class="banner-content">
	                    ...
	                    <div class="intrunk-banner-buttons">
...
add_shortcode( 'intrunk_banners', 'intrunk_banner_section_shortcode' );
// End bannerr shortcode


// Colored section shortcode
function intrunk_colored_section_shortcode($atts, $content = null) {
	extract( shortcode_atts( 
		array(
			'colored_bg'	=> '',
			'bg_color'		=> '',
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12">
                	<div class="colored-content">
	                    ...
	                    <div class="intrunk-colored-buttons">
...
add_shortcode( 'colored_section', 'intrunk_colored_section_shortcode' );
// End colored shortcode


// Colored grey section shortcode
function intrunk_colored_grey_section_shortcode($atts, $content = null) {
	extract( shortcode_atts( 
		array(
			'colored_bg'	=> '',
			'bg_color'		=> '',
...
add_shortcode( 'colored_grey_section', 'intrunk_colored_grey_section_shortcode' );
// End colored shortcode


// Section title shortcode 
function intrunk_section_title_shortcode( $atts ) {
    ...
    $section_title_markup = '
        <div class="intrunk-section-title theme-'.esc_attr( $style ).' text-'.esc_attr( $text_align ).'">
...
add_shortcode( 'intrunk_section_title', 'intrunk_section_title_shortcode' );
	...
	<div class="row">
		...
		<div class="col-sm-12">
			...
			while ($q->have_posts()) : $q->the_post();
                ...
                if (get_post_meta( $post_id, 'intrunk_premium_brand_options', true )) {
                    $intrunk_brand_meta = get_post_meta( $post_id, 'intrunk_premium_brand_options', true );
                } else {
                    $intrunk_brand_meta = array();
                }

                if (array_key_exists('kurian_title', $intrunk_brand_meta)) {
                    $kurian_title = $intrunk_brand_meta['kurian_title'];
                } else {
                    $kurian_title = '';
                }

                if (array_key_exists('link_to_external_page', $intrunk_brand_meta)) {
                    $link_to_external_page = $intrunk_brand_meta['link_to_external_page'];
                } else {
...
function intrunk_indie_brands_project_shortcode($atts) {
	extract( shortcode_atts( 
		array(
			'count'		=> -1,
	), $atts ));
	...
	<div class="row">
		...
		<div class="col-sm-12">
			...
			while ($q->have_posts()) : $q->the_post();
                ...
                if (get_post_meta( $post_id, 'intrunk_indie_brand_options', true )) {
                    $intrunk_indie_brand_options = get_post_meta( $post_id, 'intrunk_indie_brand_options', true );
                } else {
                    $intrunk_indie_brand_options = array();
                }

                if (array_key_exists('indie_kurian_title', $intrunk_indie_brand_options)) {
                    $indie_kurian_title = $intrunk_indie_brand_options['indie_kurian_title'];
                } else {
                    $indie_kurian_title = '';
                }

                if (array_key_exists('link_to_external_page', $intrunk_indie_brand_options)) {
                    $link_to_external_page = $intrunk_indie_brand_options['link_to_external_page'];
                } else {
                    $link_to_external_page = '';
                }
...
add_shortcode( 'indie_brands_project', 'intrunk_indie_brands_project_shortcode' );
// Project Indie brands shortcode end


// Brands categories pages banner shortcode
function intrunk_primium_brand_banner_shortcode($atts, $conten = null) {
	extract( shortcode_atts( 
		array(
			'brand_bg'	=> '',
			'title_type'	=> '1',
...
add_shortcode( 'primium_brand_banner', 'intrunk_primium_brand_banner_shortcode' );

// Brand wholesale shortcode start
function intrunk_brand_wholesale_shortcode($atts, $content = null) {
	extract( shortcode_atts( array(
...
add_shortcode( 'brand_wholesale', 'intrunk_brand_wholesale_shortcode' );

// Brand Images shortcode start
function intrunk_brand_image_gallery_shortcode($atts) {
	extract( shortcode_atts( array(
		'gallery_class'	=> 'left',
		'images'		=> '',
		'height'		=> '',
...
add_shortcode( 'brand_images', 'intrunk_brand_image_gallery_shortcode' );
